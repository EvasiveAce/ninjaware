...
func display_text(value: String, position: Vector2, fontSize: int, outlineSize: int):
	var text = Label.new()
	...
	text.label_settings.font_size = fontSize
	text.label_settings.outline_color = "#000"
	text.label_settings.outline_size = outlineSize
